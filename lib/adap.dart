...
class Adap extends StatefulWidget {
  const Adap({super.key});

  @override
  State<Adap> createState() => _BooksSearchPageState();
}

class _BooksSearchPageState extends State<Adap> {
...
class AddBookPage extends StatefulWidget {
  const AddBookPage({super.key, this.type = 'adap'});
