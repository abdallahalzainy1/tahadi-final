...
class Arts extends StatefulWidget {
  ...
  @override
  State<Arts> createState() => _BooksSearchPageState();
}

class _BooksSearchPageState extends State<Arts> {
...
class AddBookPage extends StatefulWidget {
  const AddBookPage({super.key, this.type = 'arts'});
