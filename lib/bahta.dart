...
class Bahta extends StatefulWidget {
  const Bahta({super.key});

  @override
  State<Bahta> createState() => _BooksSearchPageState();
}

class _BooksSearchPageState extends State<Bahta> {
...
class AddBookPage extends StatefulWidget {
  const AddBookPage({super.key, this.type = 'bahta'});
