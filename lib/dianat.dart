...
class Dianat extends StatefulWidget {
  const Dianat({super.key});

  @override
  State<Dianat> createState() => _BooksSearchPageState();
}

class _BooksSearchPageState extends State<Dianat> {
...
class AddBookPage extends StatefulWidget {
  const AddBookPage({super.key, this.type = 'dianat'});
