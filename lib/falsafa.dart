...
class Falsafa extends StatefulWidget {
  ...
  @override
  State<Falsafa> createState() => _BooksSearchPageState();
}

class _BooksSearchPageState extends State<Falsafa> {
      ...
      child: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) =>
                  const AddBookPage(type: 'falsafa'),
            ),
          );
        },
...
class AddBookPage extends StatefulWidget {
  const AddBookPage({super.key, this.type = 'falsafa'});
