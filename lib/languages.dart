...
class Languages extends StatefulWidget {
  ...
  @override
  State<Languages> createState() => _BooksSearchPageState();
}

class _BooksSearchPageState extends State<Languages> {
...
class AddBookPage extends StatefulWidget {
  const AddBookPage({super.key, this.type = 'lang'});
