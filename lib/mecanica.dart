...
class Mecanica extends StatefulWidget {
  const Mecanica({super.key});

  @override
  State<Mecanica> createState() => _BooksSearchPageState();
}

class _BooksSearchPageState extends State<Mecanica> {
      ...
      child: FloatingActionButton(
        onPressed: () {
          Navigator.push(
            ...
            MaterialPageRoute(
              builder: (_) =>
                  const AddBookPage(type: 'mecanica'),
            ),
          );
        },
...
class AddBookPage extends StatefulWidget {
  const AddBookPage({super.key, this.type = 'mecanica'});
