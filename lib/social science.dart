...
class Socialscience extends StatefulWidget {
  ...
  @override
  State<Socialscience> createState() => _BooksSearchPageState();
}

class _BooksSearchPageState extends State<Socialscience> {
...
class AddBookPage extends StatefulWidget {
  const AddBookPage({super.key, this.type = 'social'});
